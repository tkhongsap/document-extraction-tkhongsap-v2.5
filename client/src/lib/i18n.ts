...
export const translations: Translations = {
  en: {
    ...
    // Use Cases Section
    'usecases.eyebrow': 'Industry Solutions',
    'usecases.title': 'Trusted Across Industries',
    'usecases.subtitle': 'See how businesses transform their document workflows',
  ...
  th: {
    ...
    // Use Cases Section
    'usecases.eyebrow': 'โซลูชันอุตสาหกรรม',
    'usecases.title': 'ได้รับความไว้วางใจจากทุกอุตสาหกรรม',
    'usecases.subtitle': 'ดูว่าธุรกิจต่างๆ เปลี่ยนแปลง workflow เอกสารอย่างไร',
